...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: `https://www.wiyo.ae/blog/${post.slug}`,
  },
  openGraph: {
    title: post.title,
    description: post.description,
    ...
    <>
      ...
      <BlogLayout post={post}>
        <p>
          ...
          paperwork — often before lunch. So picking the right CRM isn't a
        ...
        <h2>The Criteria — What Actually Matters for Dubai Agents</h2>
        <p>
        ...
        <h2>#1 — WIYO (Best Overall for UAE Real Estate)</h2>
        <p>
        ...
        <h2>The Bottom Line for Dubai Agencies in 2026</h2>
        <p>
        ...
        <p>
          ...
          and we'll show you your own Bayut leads flowing into a WIYO
