  ...
  return (
    ...
    >
      <a
        ...
        className="flex-1 flex items-center justify-center gap-2 py-3 rounded-pill text-[14px] font-medium text-white"
        style={{
          background: "#25D366",
      ...
      <a href="/#cta" className="btn-primary flex-1 justify-center text-[14px]">
        Book Demo
